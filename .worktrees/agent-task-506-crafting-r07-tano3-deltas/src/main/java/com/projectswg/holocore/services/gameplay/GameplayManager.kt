...
import com.projectswg.holocore.services.gameplay.bots.BotManager
...
@ManagerStructure(children = [BazaarService::class, BotManager::class, CombatManager::class, ConversationService::class, CraftingManager::class, DeathCyberneticService::class, DestroyMissionService::class, EntertainmentManager::class, FactionManager::class, JediManager::class, JunkDealerService::class, PlayerManager::class, StructuresManager::class, TradeService::class, WorldManager::class])
