# PD7-G: Wire companion recruit command

## Scope: src/main/java/com/projectswg/holocore/services/support/global/admin/AdminBotService.kt

## Description
The recruit branch of handleCompanion() has already been implemented and the full corrected file is embedded below. Write it directly.

Full file contents — write EXACTLY this:
